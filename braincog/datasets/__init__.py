from .datasets import build_transform, build_dataset, get_mnist_data, get_fashion_data, \
    get_cifar10_data, get_cifar100_data, get_esimnet_data, get_dvsg_data, get_dvsc10_data, \
...
__all__ = [
    ...
    'get_mnist_data', 'get_fashion_data', 'get_cifar10_data', 'get_cifar100_data', 'get_esimnet_data',
...
def is_dvs_data(dataset):
    if dataset == 'dvsg' or dataset == 'dvsc10' or dataset == 'NCALTECH101' or dataset == 'NCARS' or dataset == 'DVSG' or dataset == 'esimnet':
        return True
    else:
        return False
